...
namespace DiatoCript
{
     ...
     * del controlador del esclavo para hacer las diferentes
     * funciones que necesita para funcionar como esclavo.
     * Tiene una instancia del formulario (vista) del maestro
